...
export class InventarioService {
  ...
  getAll(): Observable<Inventario[]> { return this.http.get<Inventario[]>(API); }
  getByBicicleta(id: number): Observable<Inventario> { return this.http.get<Inventario>(`${API}/bicicleta/${id}`); }
  getAlertas(): Observable<Inventario[]> { return this.http.get<Inventario[]>(`${API}/alerta`); }
